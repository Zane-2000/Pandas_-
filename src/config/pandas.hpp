...
// ============================================================================
	...
	#define Pandas_Version "1.1.10.0"
...
// ============================================================================
	...
	// 是否启用 checkcartweight 脚本指令 [人鱼姬的思念]
	// 该指令用于查询角色手推车负重
	#define Pandas_ScriptCommand_CheckCartWeight

	// 是否启用 checkcartmaxweight 脚本指令 [人鱼姬的思念]
	// 该指令用于查询角色手推车最大负重
	#define Pandas_ScriptCommand_CheckCartMaxWeight
